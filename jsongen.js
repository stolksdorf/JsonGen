(function(){
	...
	jsongen.functions = {
		...
		email : function()
		{
			var suffix = randomFromArray(['.org', '.net', '.com', '.com', '.com', '.biz']);
			return (this.firstname().substring(0,1) + this.lastname() + '@' + this.company().replace(new RegExp(' ', 'g'),'') + suffix).toLowerCase();
		},
		company : function()
		{
