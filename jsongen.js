(function(){
	...
	jsongen = function(blueprint){
		...
		var processLayer = function(obj, index){
			...
			if(_.isArray(obj)){
				...
				return processString.call(_.extend(jsongen.functions, {t_index: index}), obj, index);
	...
	jsongen.definitions = {
		...
		companyNames : ['Aeon Agricultural Cargo', 'American Scientific Logistics', 'Atkinson General Memory Pharmecutical', 'British Informational Products', 'Castillo Engineered Specialized Products', 'Chinese Software Entertainment', 'Control Of San Jose', 'Decker Mangonetics', 'Digital Medical', 'Dynabank', 'Genetidynamics', 'Hickman Cybersys', 'Hodges Mangosys', 'Horn Systems Of Annapolis', 'Japanese Tool Healthcare', 'Logistics Peripherals', 'Mcgowan Sciences Of Lima', 'Mexican Strategic', 'Mutual Equipment Engineering', 'Software Leasing', 'Spanish Future Financial', 'Stone Service Containers', 'Talley Housing Sciences Telecommunications', 'Unico', 'Wise Tronics', 'Cherry Memory Scientific', 'Engineered Unlimited Housing', 'Genetics Solar Healthcare', 'Gold Integration Logistics', 'Harmon Radio Health Research', 'Health Chemical Equipment', 'Japanese Grocery', 'Larson Apex Products', 'Lawson Manufacturing Biological', 'Limited Research Integration', 'Martinez Cosmosystems', 'Media Of Los Angeles', 'Medical Cryonautics', 'Morin Space Holdings', 'Motors Of Paris', 'Nuclear Imperial Agricultural', 'Paragon Royal Holdings', 'Photocorporation', 'Russian Solar', 'Ryan Genenautics', 'Scientific Of Dublin', 'Skinner Microtechnics', 'Spanish Engineering Electric', 'Tool Semiconductor', 'Unlimited Instruments', 'American Pollution Mechanical', 'Australian Electric Unlimited', 'Biocom', 'Cohen Tactical Office Logistics', 'Cooke Development Solar', 'Cyberinnovations', 'Edwards Advanced Apparel', 'European Alternative Agricultural', 'European Integrated Technology', 'Foreign Genetics Housing', 'Gordon Astrosys', 'Grimes Wholesale Health Entertainment', 'Harvey System Digital', 'Integrated Entertainment Service', 'Megacorporation', 'Mills Solar Computers', 'Mooney Mation', 'Oil Vista Publishing', 'Open Logistics Machines', 'Paragon Railroads', 'Rodriquez Technology Entertainment', 'Russian Power', 'Sims Specialized Instrument Grocery', 'Technology Integration', 'Tillman Personal Future Holding', 'Alford Speciality Research Photographic', 'American Speciality Applications', 'Automotive Of Copenhagen', 'Automotive Of Mexico City', 'Ayala Cryptotech', 'Carlson Applications Of San Francisco', 'Chan Automotive Pollution Atomic', 'Digital Biological', 'Fields Entertainment Solar', 'Grocery Of London', 'Healthy Products', 'Instrument Brokers', 'Leblanc Paragon Health Vista', 'Mason Humanosystems', 'Media Entertainment Horizons', 'Media Vista Cargo', 'Medical Chemical Instruments', 'Metals Of Brussels', 'Microtronics', 'Nuclear Of Monaco', 'Office Instructional Dynamics', 'Personal Scientific Semiconductors', 'Stafford Digital', 'Strategic Implementations', 'Transportation Motors'],
	...
	jsongen.functions = {
		...
		email : function()
		{
			return (this.firstname().substring(0,1) + this.lastname() + '@' + this.company().replace(new RegExp(' ', 'g'),'') + '.com').toLowerCase();
		},
		company : function()
		{
